...
Generated on Thu, 20 May 2021 16:27:39
...
* URL: [https://acceslibre.beta.gouv.fr/app/09-bagert/a/centre-de-vaccination/erp/prat-et-bonrepaux-operation-ephemere-vaccination/](https://acceslibre.beta.gouv.fr/app/09-bagert/a/centre-de-vaccination/erp/prat-et-bonrepaux-operation-ephemere-vaccination/)
...
* URL: [https://acceslibre.beta.gouv.fr/api/docs/](https://acceslibre.beta.gouv.fr/api/docs/)
  ...
  * Evidence: `7gYDid5hSm5SxAFXNBfiASluoTg1NzM29hQToqKkJ4YbaxNjwwaThJeI1HuLYKCk`
...
* URL: [https://acceslibre.beta.gouv.fr/accounts/login/?next=/](https://acceslibre.beta.gouv.fr/accounts/login/?next=/)
  ...
  * Evidence: `ETi0UfVLzqhSZxdKSDRZ5vw9TuzN0Q57928wirYFIW1Oli3TTy8SWpo3V64XEREo`
...
### Other information
<p>�\x0006\x0003��aJnR�\x0001W4\x0017�\x0001)n�85736�\x0014\x0013���'�\x001bk\x0013c�\x0006�����{�`��</p>
...
* URL: [https://acceslibre.beta.gouv.fr/accounts/login/?next=/contrib/start/](https://acceslibre.beta.gouv.fr/accounts/login/?next=/contrib/start/)
...
### Other information
<p>User-controlled HTML attribute values were found. Try injecting special characters to see if XSS might be possible. The page at the following URL:</p><p></p><p>https://acceslibre.beta.gouv.fr/accounts/login/?next=/accounts/login/</p><p></p><p>appears to include user input in: </p><p></p><p>a(n) [input] tag [value] attribute </p><p></p><p>The user input found was:</p><p>next=/accounts/login/</p><p></p><p>The user-controlled value was:</p><p>/accounts/login/</p>
