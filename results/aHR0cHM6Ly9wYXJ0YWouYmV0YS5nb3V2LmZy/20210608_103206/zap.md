...
Generated on Tue, 8 Jun 2021 10:13:28
...
* URL: [https://partaj.beta.gouv.fr/](https://partaj.beta.gouv.fr/)
  ...
  * Evidence: `VHvgEZqLX6I0cqR31Q8113eA58VPoTpTRApUUHLeOkXdMrkuN7gsIhPdVW51HLmw`
...
* URL: [https://partaj.beta.gouv.fr](https://partaj.beta.gouv.fr)
  ...
  * Evidence: `EXky4IoOiNIVJfk9PhXcWtORE0EBYvGw1l6TbMzoV3E0yjAyREzifRUJ4RimmaKx`
...
### Other information
<p>T{�\x0011��_�4r�w�\x000f5�w���O�:SD</p><p>TPr�:E�2�.7�,"\x0013�Unu\x001c��</p>
...
### Other information
<p>The following comment/snippet was identified via the pattern: \bWHERE\b</p><p><!--</p><p>      Fix a nasty issue in Safari where it is impossible to make a table-row into a containing block. When we then stretch</p><p>      the links in our tables it breaks and covers the whole page. This safari only hack enables us to disable link-stretching</p><p>      in safari, and remove the pointer cursor.</p><p>      Users then have to click on the actual link in the row header.</p><p>    --></p><p>The following comment/snippet was identified via the pattern: \bADMIN\b</p><p><script></p><p>      window.__partaj_frontend_context__ = JSON.parse('{"assets": {"icons": "/static/core/icons.3bcb715b06cf.svg"}, "csrftoken": "v4A9zf8cxqjDTbRrUtTYb88A4o30TopISsmuGjjMaGfIIf7QWQv4uwesufHLh3tJ", "environment": "production", "url_admin": "/admin/", "url_logout": "/accounts/logout", "sentry_dsn": "https://be48f0adfc39472681ee7ff96bc88c99@o442012.ingest.sentry.io/5413011"}');</p><p>    </script></p><p></p>
